import { lerpMap } from 'ReplicatedStorage/shared/utils/math'
...
export const fonts = {
  inter: {
    regular: new Font('rbxassetid://12187370000'),
    medium: new Font('rbxassetid://12187370000', Enum.FontWeight.Medium),
    bold: new Font('rbxassetid://12187370000', Enum.FontWeight.Bold),
  },
  robotoMono: {
...
export function calculateRem(
  ...
  const factor = desktop ? scale : lerpMap(scale, 0, 1, 0.25, 1)
